 ...
 * @author Lenovo
 */
public class Diseño_13x13 extends javax.swing.JFrame {
    ...
    public Diseño_13x13(String players) {
       initComponents();
       setLocationRelativeTo(null);
        ...
        for (int row = 12; row >= 0; row--) {
            for (int col = 0; col < 13; col++) {
                ...
                if (number == 123 || number == 138 || number == 149 || number == 13 || number == 14 || number == 39 || number == 40 || number == 65 || number == 74
                        || number == 83 || number == 100 || number == 130 || number == 131 || number == 156 || number == 157 || number == 121 || number == 140 || number == 3
                        || number == 24 || number == 29 || number == 72 || number == 85 || number == 98 || number == 111) {
                    subPanel.setBorder(BorderFactory.createLineBorder(Color.MAGENTA)); // Borde naranja
                }
                if (number == 168 || number == 145 || number == 142 || number == 119 || number == 116 || number == 93 || number == 90 || number == 67 || number == 64
                        || number == 41 || number == 38 || number == 15 || number == 12 || number == 107 || number == 102 || number == 81 || number == 76
                        || number == 55 || number == 71 || number == 60 || number == 45 || number == 34 || number == 19 || number == 161 || number == 152
                        || number == 135 || number == 126 || number == 95 || number == 88 || number == 69 || number == 62 || number == 43 || number == 78
                        || number == 53 || number == 52 || number == 27 || number == 26 || number == 48 || number == 31 || number == 22 || number == 5) {
    ...
    public void moverJugador(int espacios) {
        ...
        if (nuevaPosition >= 169) {
            nuevaPosition = 168; // Asegurar que no se salga del tablero
        }
    ...
    private void initComponents() {
        ...
        jPanelJuego.setLayout(new java.awt.GridLayout(13, 13, 2, 2));
        jPanelPrincipal.add(jPanelJuego, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 30, 550, 550));
        ...
        jPanelPrincipal.add(jPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(610, 40, -1, -1));
        ...
        jPanelPrincipal.add(btn_titar_dado, new org.netbeans.lib.awtextra.AbsoluteConstraints(650, 180, 150, 40));
        ...
        jPanelPrincipal.add(btn_reiniciar, new org.netbeans.lib.awtextra.AbsoluteConstraints(650, 230, 150, 40));
        ...
        jPanelPrincipal.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(580, 280, 280, 360));
        jPanelPrincipal.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 630, -1, -1));

        lb_dado.setForeground(new java.awt.Color(0, 0, 0));
        lb_dado.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jPanelPrincipal.add(lb_dado, new org.netbeans.lib.awtextra.AbsoluteConstraints(610, 40, 100, 100));

        lb_jugador.setFont(new java.awt.Font("Segoe UI Light", 1, 14)); // NOI18N
        lb_jugador.setForeground(new java.awt.Color(0, 0, 0));
        lb_jugador.setText("Jugador Rojo:");
        jPanelPrincipal.add(lb_jugador, new org.netbeans.lib.awtextra.AbsoluteConstraints(730, 90, 120, 30));

        jLabel2.setFont(new java.awt.Font("Segoe UI", 0, 24)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(0, 0, 0));
        jLabel2.setText("Turno De:");
        jPanelPrincipal.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(730, 50, -1, -1));

        jLabel4.setBackground(new java.awt.Color(255, 255, 255));
        jLabel4.setOpaque(true);
        jPanelPrincipal.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 20, 250, 140));

        jLabel3.setBackground(new java.awt.Color(153, 0, 255));
        jLabel3.setOpaque(true);
        jPanelPrincipal.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(580, 0, 290, 650));

        jLabel5.setBackground(new java.awt.Color(255, 255, 255));
        jLabel5.setOpaque(true);
        jPanelPrincipal.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 20, 570, 570));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Diseño_13x13.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
               // new Diseño_13x13().setVisible(true);
            }
        });
    }
